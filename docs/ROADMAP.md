...
**2026-09-07：GitHub 仓库已建立，按用户要求收尾并暂停开发。** 私有仓库为 [Water-Run/Power](https://github.com/Water-Run/Power)，当前 C# 基线已通过 Windows、macOS、Linux 的远程自动验收。恢复时继续 Unity 实际导入验收和下述剩余项。
