...
- Native prototypes under `legacy/native` use Zig 0.15.2, per the owner's direction. Keep the repository free of C/C++ source and headers. Preserve original C provenance through Git and `legacy/native/migration-manifest.json`; follow `docs/NATIVE_ZIG.md` and keep the active C#/Unity contracts.
